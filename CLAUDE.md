...
- **Idempotency**: `scanned` label prevents re-processing
...
`urgent`, `action needed`, `follow-up`, `meeting`, `awaiting-reply`, `payment`, `info`, `newsletter`, `marketing`, `notification`, `estimates`
...
2. Copy into Apps Script editor at script.google.com
